...
_This repository is very much a work in progress. It's realized vision is still unclear. The goal is to make certain aspects of PIC-SURE maintenance and administration easier._

_The repository is a testing ground for exploring various ideas with possibly lots of breaking changes to come or abandonment. At worst case, it can serve as an example of what not to to :-) ._

_The work is currently unaffiliated with [hms-dbmi][8], the primary drivers of PIC-SURE and GIC._
